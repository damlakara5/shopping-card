...
type ShoppigCardProps = {
    isOpen : boolean
}

export function ShoppingCard ({isOpen} : ShoppigCardProps) {
        ...
        <Offcanvas show={isOpen}  onHide={closeCard} placement="end">
            ...
            <Offcanvas.Body>
                <Stack gap={3}>
                    ...
                    <div className="ms-auto fw-bold fs-5"> Total {formatCurrency(cardItems.reduce((total, cardItem) =>{
